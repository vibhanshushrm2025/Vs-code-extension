...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("LiveQD-sidebar", sidebarProvider));
    context.subscriptions.push(vscode.commands.registerCommand("LQD.RefreshWebviews", () => {
